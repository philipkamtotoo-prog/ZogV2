...
| 道具     | 价格    | 效果                     | 副作用 / 限制                                       |
| ------ | ----- | ---------------------- | ---------------------------------------------- |
| 劣质机油   | 80 G  | 目标演员恢复 20 HP           | 20% 概率获得”肠胃不适”，下一次行动无法攻击                       |
| 急救罐头   | 150 G | 目标演员恢复 35 HP           | 无副作用                                           |
| 高能嘲讽电池 | 350 G | 目标演员恢复 60 HP，并获得 1 次护盾 | 目标获得 TAUNT_1_ACTION 状态，下 1 次行动前被其他演员优先攻击     |
